...
function Products(props) {
  ...
  return (
    <>
    <h1 className="text-center p-4" id="judul" style={{color:"#ffb945"}}>List of Products</h1>
    ...
    {data.filter((datas)=> datas.title.toLowerCase().includes(searchTerm.toLowerCase())).map((datas, index) => ( 
        ...
        style={{ width: "18rem", border:"#ffb945 3px solid", borderRadius:'10px'}}
      >
        ...
        <div className="card-body">
          ...
          <button className="btn" value={props.count} onClick={() => props.setCount(props.count+1)} >
           Add to cart
          </button>
        </div>
      </div>
